        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-body-md text-on-surface-variant">
              By creating an account or otherwise using HUGE RECRUITMENT LIMITED (company number
              17321402) (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not
              agree to these terms, do not register for or use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-body-md text-on-surface-variant mb-3">
              HUGE RECRUITMENT LIMITED provides tools to help job seekers and employers connect. When using the Service,
              you agree not to:
            </p>
          ...
          <section>
            ...
            <p className="text-body-md text-on-surface-variant">
              The Service, including its design, branding, and underlying software, is owned by HUGE RECRUITMENT LIMITED
          ...
          <section>
            ...
            <p className="text-body-md text-on-surface-variant">
              HUGE RECRUITMENT LIMITED is a platform that facilitates connections between job seekers and employers. We
          ...
          <section>
            ...
            <p className="text-body-md text-on-surface-variant">
              To the fullest extent permitted by law, HUGE RECRUITMENT LIMITED will not be liable for any indirect,

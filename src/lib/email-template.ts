                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td style="padding: 16px 0 0 0; font-size: 14px; color: ${COLOR_MUTED};">
                      Need help? Contact us at <a href="mailto:info@hugerecruitment.co.uk" style="color: ${COLOR_PRIMARY};">info@hugerecruitment.co.uk</a>.
                    </td>
                  </tr>
                </table>
              </td>
...
export function renderBrandedEmailText({
  heading,
  bodyText,
  ctaLabel,
  ctaUrl,
  ...
  lines.push(
    "",
    "Need help? Contact us at info@hugerecruitment.co.uk.",
    "",
    BRAND_NAME,
  );
  return lines.join("\n");
